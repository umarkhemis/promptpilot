    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-50 to-white dark:from-slate-900 dark:to-slate-800 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-slate-500 dark:text-slate-400">Start prompting like a pro — free forever</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              />
              {password && (
                <div className={`flex items-center gap-1.5 mt-1.5 text-xs ${passwordStrong ? "text-green-600" : "text-amber-500"}`}>
