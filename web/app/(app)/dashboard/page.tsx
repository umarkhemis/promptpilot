...
import {
  AlertCircle, Sun, Moon, ChevronDown, ChevronUp,
  Sparkles, History, BookOpen, Settings, LogOut,
  Zap, LayoutGrid, Wand2,
} from "lucide-react";
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        >
          <button
            ...
            className="w-full flex items-center justify-between px-5 py-3.5 text-left transition-colors duration-200"
            style={{ color: muted }}
          >
          ...
          {showContext && (
            <div className="px-5 pb-4" style={{ borderTop: `1px solid ${border}` }}>
              <p className="text-xs mt-3 mb-2" style={{ color: muted }}>
                Add context so the AI tailors the improved prompt to your specific needs.
              </p>
              <textarea
                value={context}
                ...
                onFocus={(e) => {
                  e.currentTarget.style.borderColor = "rgba(108,58,255,0.45)";
                  e.currentTarget.style.boxShadow = "0 0 0 3px rgba(108,58,255,0.1)";
                }}
                onBlur={(e) => {
        ...
        {(output || isStreaming) && (
          ...
          >
            {/* Left: output + clarifying questions */}
        ...
        {/* Empty state — shown before first use */}
        {!output && !isStreaming && !error && (
          ...
          >
            ...
            <p className="text-sm max-w-sm mx-auto" style={{ color: muted }}>
              Type your rough idea above, hit <span className="font-semibold" style={{ color: "#a78bfa" }}>Improve Prompt</span>, and watch the magic happen.
            </p>
            <div className="flex items-center justify-center gap-6 mt-6">
              {[
                { label: "Structured", color: "#6C3AFF" },
                { label: "Specific",   color: "#06B6D4" },
                { label: "Actionable", color: "#34d399" },
              ].map(({ label, color }) => (
