...
const METRICS = [
  { key: "clarity", label: "Clarity", target: 94, color: "#34d399" },
  { key: "specificity", label: "Specificity", target: 88, color: "#a78bfa" },
  { key: "output", label: "Output fit", target: 97, color: "#06B6D4" },
];
...
export function Hero() {
  ...
  const [metricVals, setMetricVals] = useState({ clarity: 0, specificity: 0, output: 0 });
  ...
  const animateMetrics = useCallback(() => {
    ...
    const iv = setInterval(() => {
      ...
      setMetricVals({
        clarity: Math.round(94 * ease),
        specificity: Math.round(88 * ease),
        output: Math.round(97 * ease),
      });
  ...
  const runCycle = useCallback(() => {
    ...
    setMetricVals({ clarity: 0, specificity: 0, output: 0 });
    setShowTool(false);
              ...
              if (j < AFTER_TEXT.length) {
                ...
                const t2 = setTimeout(() => {
                  ...
                  const t3 = setTimeout(() => {
                    ...
                    const t4 = setTimeout(() => {
                      setPhase("resetting");
                      const t5 = setTimeout(() => runCycle(), 500);
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="flex flex-col items-start justify-center">
            ...
            {/* Sub-headline */}
            <p
              className="text-lg sm:text-xl mb-10 leading-relaxed max-w-md"
              style={{ color: "#94a3b8" }}
            >
            ...
            <div className="flex flex-col sm:flex-row items-start gap-3 mb-10">
              <Link
                href="/register"
                className="group inline-flex items-center gap-2 font-semibold px-7 py-3.5 rounded-xl text-base transition-all duration-200 text-white"
                style={{
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center gap-2 font-semibold px-7 py-3.5 rounded-xl text-base transition-all duration-200"
                style={{
                  color: "#cbd5e1",
          ...
          {/* RIGHT: Demo card */}
          <div className="flex flex-col justify-center lg:h-[calc(100vh-8rem)]">
            <div
              className="rounded-2xl overflow-hidden flex flex-col"
              style={{
                background: "rgba(18, 18, 34, 0.9)",
                border: "1px solid rgba(255,255,255,0.08)",
                boxShadow: "0 40px 100px rgba(0,0,0,0.7), 0 0 0 1px rgba(108,58,255,0.07)",
            ...
            >
                    ...
                    {METRICS.map((m) => (
                      ...
                      >
                        <div
                          ...
                          style={{ color: m.color }}
                        >
                          {metricVals[m.key as keyof typeof metricVals]}%
                        </div>
              ...
              {/* Progress bar */}
              <div style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }} className="flex-shrink-0">
                <div
                  style={{
                    height: "2px",
                    background: "linear-gradient(90deg, #6C3AFF, #06B6D4)",
                    width: phase === "done" ? "100%" : "0%",
                    transition: phase === "done" ? "width 10s linear" : "width 0s",
                  }}
                />
              </div>
              ...
              {/* Status label */}
              <p
                className="text-xs font-mono text-center py-2 flex-shrink-0"
                style={{ color: "#334155", minHeight: "2rem" }}
              >
                {phase === "done" && "replaying in 10s..."}
