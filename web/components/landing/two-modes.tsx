    ...
    <section className="py-24 px-4 bg-gradient-to-br from-[#1A0A2E] via-[#0F0F1A] to-[#0A1A2E] relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Marketing Mode */}
          <div className="animate-on-scroll-left bg-gradient-to-br from-[#6C3AFF]/20 to-[#6C3AFF]/5 border border-[#6C3AFF]/30 rounded-2xl p-8 hover:border-[#6C3AFF]/60 transition-all duration-300">
          ...
          {/* Student Mode */}
          <div className="animate-on-scroll-right bg-gradient-to-br from-[#06B6D4]/20 to-[#06B6D4]/5 border border-[#06B6D4]/30 rounded-2xl p-8 hover:border-[#06B6D4]/60 transition-all duration-300">
            <div className="text-4xl mb-4">📚</div>
